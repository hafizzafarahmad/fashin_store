...
class AppTheme {
  static final main = ThemeData(
    ...
    textTheme: GoogleFonts.poppinsTextTheme().copyWith(
      ...
      labelLarge: GoogleFonts.poppins(fontWeight: FontWeight.w600, fontSize: 16.0),
      bodySmall: GoogleFonts.poppins(fontWeight: FontWeight.w500, fontSize: 14.0),
    ),
